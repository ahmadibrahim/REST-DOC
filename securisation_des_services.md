...
Dansle cadre d'un token, ce même entête HTTP pourra être utilisé. Dans ce cas par contre, le user et password corresponde à une API KEy dédiée partagée par plusieurs utilisateurs potentiellement.
