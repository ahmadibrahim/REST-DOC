...
### Layered System
A client cannot guess if he is directly connected to the target application server or if he is served by a proxy server. Usually theses proxies may be load balancers, shared cache services or authentication and habilitation services.
