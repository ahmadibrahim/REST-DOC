...
Composition versus association : On modélisera une composition lorsque l'appel REST renverra dans le flux le sous objet complet, et une association lorsque l'appel REST renvoie uniquement un identifiant technique et/ou fonctio
