...
| HTTP Verb | URI1 | / URI2 |
| -- | -- | -- |
| Description | The business analyst only requires knowledge of the order to access the order line of the said order.| In the second case, access to the order lines also requires to know the customer. |
