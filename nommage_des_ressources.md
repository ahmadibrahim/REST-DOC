...
3. Le format du message retourné doit être indiqué dans le Header (champ dédié à préciser) . Il s'agit d'une information protocole indépendante du contexte fonctionnel de la requête, cette information doit donc être mise dans le Header.
